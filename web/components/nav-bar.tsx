  ...
  const titleMarkup = useMemo(() => {
    return (
      <div>
        ...
        <p className='text-muted-foreground text-sm'>{getDescription(currentPath)}</p>
      </div>
    );
  }, [currentPath]);
                ...
                <DropdownMenuContent className='w-56' align='end' sideOffset={5}>
                  <DropdownMenuLabel className='font-normal'>
                    <div className='flex flex-col space-y-1'>
                      <p className='text-sm font-medium leading-none'>Minh</p>
                    ...
                    <div className='flex items-center justify-between pb-4 border-b border-border'>
                      <Link
                        ...
                        <div>
                          ...
                          <p className='text-xs text-muted-foreground'>Nền tảng học AI</p>
                        </div>
                      </Link>
                    </div>
                    ...
                    <div className='border-t border-border pt-4 mt-auto'>
                      <div className='flex items-center space-x-3 px-3 py-2 mb-3'>
                        ...
                        <div className='flex flex-col'>
                          ...
                          <p className='text-xs text-muted-foreground'>leminhquy@ailabviet.com</p>
                        </div>
                      </div>
