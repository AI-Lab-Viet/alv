...
export default function AnalysisModal({ isOpen, toggleAnalysis, analysis }: AnalysisModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={toggleAnalysis}>
      <DialogPortal>
        <DialogOverlay />
        ...
        <DialogContent>
          ...
          <div className="grid grid-cols-1 gap-4">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">{analysis?.analysis.summary}</p>
              </CardContent>
            </Card>
          ...
          <DialogFooter>
            <div className="flex flex-col gap-2 w-full">
              <p className="text-sm text-gray-500 text-right">Xem nhiều hơn ở Portofolio của bạn nhé</p>
              <div className="flex flex-row gap-4 items-center justify-end">
                ...
                <Button onClick={toggleAnalysis} variant="outline">
                  Đóng
                </Button>
              </div>
