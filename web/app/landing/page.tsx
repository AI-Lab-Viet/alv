              ...
              <div className="text-gray-800 space-y-8">
                ...
                <div className="space-y-4">
                  <h1 className="font-bold text-5xl lg:text-7xl leading-tight">
                    <span className="block text-gray-800">Đồng hành cùng AI</span>
                ...
                <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-2xl">
                  AI Lab Việt là nền tảng đầu tiên tại Việt Nam giúp bạn rèn luyện tư duy và kỹ năng hợp tác sáng tạo cùng AI thông qua các dự án thực chiến, được dẫn dắt bởi Huấn luyện viên AI - ALVA.
                </p>
                    ...
                    <DialogContent className="sm:max-w-md">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                          {isSubmitting ? (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Nhiều người đang sử dụng AI nhưng chưa thực sự hiểu rõ những rủi ro và cách tối ưu hóa hiệu quả
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-white font-medium">Lịch tập có hệ thống (Giáo trình)</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                        <span className="text-white text-sm">🤖</span>
                      </div>
                      <span className="text-white font-medium">Sửa form tức thì (ALVA)</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                        <span className="text-white text-sm">📈</span>
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center gap-4 bg-white rounded-full px-8 py-4 shadow-lg border border-gray-200">
              <span className="text-lg text-gray-700">Sẵn sàng có một "Personal Trainer" cho AI?</span>
              <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogTrigger asChild>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Quy trình học tập có cấu trúc, từ nền tảng đến thành thạo, được thiết kế để đảm bảo bạn phát triển bền vững
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-4 bg-gray-100 rounded-full px-8 py-4">
              <span className="text-gray-700 font-medium">Thời gian hoàn thành:</span>
              <div className="flex items-center gap-2">
                <span className="text-2xl">⏱️</span>
                <span className="font-bold text-blue-600 text-lg">4-6 tuần</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
                ...
                <div className="relative group">
                  <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 hover:shadow-3xl transition-all duration-500">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-sm text-gray-500">4 Kỹ năng cốt lõi + Synthesis</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative group">
                  <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-8 shadow-xl border border-yellow-200 hover:shadow-2xl transition-all duration-500">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-sm text-gray-500">Synthesis & Sáng tạo</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br from-yellow-400/20 to-orange-400/20 rounded-full animate-pulse" style={{ animationDelay: "1s" }}></div>
            </div>
              ...
              <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl border border-gray-200">
                <div className="space-y-6">
                  ...
                  <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-purple-100 px-4 py-2 rounded-full">
                    ...
                    <span className="font-semibold text-gray-700">Tài sản Trí tuệ Việt Nam</span>
                  </div>

                  {/* Main Description */}
                  <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    Được truyền cảm hứng từ nền tảng 4D của thế giới, chúng tôi bổ sung vào đó mảnh ghép{" "}
                  ...
                  <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed">
                    ...
                    còn là biểu tượng của dải đất Việt Nam, là cam kết của chúng tôi trong việc trao quyền cho trí tuệ Việt.
                  </p>
                  ...
                  <div className="space-y-4 pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 mb-2">4 Kỹ năng Cốt lõi</h4>
                        <p className="text-gray-600">Delegation, Description, Discernment, Diligence</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 mb-2">+S Synthesis</h4>
                        <p className="text-gray-600">Tổng hợp & Sáng tạo - Bản sắc Việt Nam</p>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-20 px-4 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Hồ sơ Năng lực Số của bạn - minh chứng cụ thể về khả năng hợp tác sáng tạo cùng AI
            </p>
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-3">
              <div className="relative group">
                ...
                <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full animate-pulse" style={{ animationDelay: "1s" }}></div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-8 border border-gray-200">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Sản phẩm Hoàn chỉnh</h4>
                      <p className="text-gray-600 text-sm">Kết quả thực tế từ dự án với AI</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Câu lệnh Tiêu biểu</h4>
                      <p className="text-gray-600 text-sm">Prompts hiệu quả đã sử dụng</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Suy ngẫm & Bài học</h4>
                      <p className="text-gray-600 text-sm">Quá trình học hỏi và phát triển</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Kỹ năng đã Thể hiện</h4>
                      <p className="text-gray-600 text-sm">Tags các kỹ năng 4D+S đã áp dụng</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-500 to-blue-600 rounded-3xl p-8 text-white">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">✅</span>
                    <span className="font-medium">Chứng minh năng lực với nhà tuyển dụng</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">✅</span>
                    <span className="font-medium">Portfolio cá nhân độc đáo</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">✅</span>
                    <span className="font-medium">Kỹ năng AI được xác thực</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">✅</span>
                    <span className="font-medium">Lợi thế cạnh tranh trên thị trường</span>
                  </div>
                </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8 text-center">
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-6">
              ...
              <div className="text-gray-700 font-medium">Học viên hoàn thành có Portfolio</div>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-2xl p-6">
              ...
              <div className="text-gray-700 font-medium">Dự án thực tế trong Hồ sơ</div>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-purple-50 rounded-2xl p-6">
              <div className="text-3xl font-bold text-green-600 mb-2">85%</div>
              <div className="text-gray-700 font-medium">Nhà tuyển dụng quan tâm kỹ năng AI</div>
            </div>
          </div>
        </div>
      </section>
                ...
                <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                  <DialogTrigger asChild>
                    <button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.boxShadow = '0 0 40px rgba(34, 211, 238, 0.6), 0 0 80px rgba(59, 130, 246, 0.4)';
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.boxShadow = '0 0 30px rgba(34, 211, 238, 0.3), 0 0 60px rgba(59, 130, 246, 0.2)';
                      }}
                    >
                      {/* Animated background */}
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="py-16">
            <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-xl mb-4 text-cyan-400">AI Lab Việt</h3>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="/team" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Đội ngũ sáng lập
                    </a>
                  </li>
                  <li>
                    <a href="/mission" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Sứ mệnh & Tầm nhìn
                    </a>
                  </li>
                  <li>
                    <a href="/blog" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Blog & Tin tức
                    </a>
                  </li>
                  <li>
                    <a href="/careers" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Tuyển dụng
                    </a>
                  </li>
                </ul>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="/skill-hub" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Võ đường Huấn luyện
                    </a>
                  </li>
                  <li>
                    <a href="/project-hub" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Xưởng Thực chiến
                    </a>
                  </li>
                  <li>
                    <a href="/portfolio" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Hồ sơ Năng lực
                    </a>
                  </li>
                  <li>
                    <a href="/framework" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Framework 4D+S
                    </a>
                  </li>
                  <li>
                    <a href="/alva" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Gặp gỡ ALVA
                    </a>
                  </li>
                </ul>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="/help" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Trung tâm Hỗ trợ
                    </a>
                  </li>
                  <li>
                    <a href="/faq" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Câu hỏi thường gặp
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/community" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Cộng đồng
                    </a>
                  </li>
                  <li>
                    <a href="/feedback" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">
                      Phản hồi
                    </a>
                  </li>
                </ul>
          ...
          <div className="py-8 border-t border-gray-800">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                ...
                <a href="/accessibility" className="text-gray-400 hover:text-cyan-400 transition-colors">
                  Khả năng tiếp cận
                </a>
              </div>
            </div>
          ...
          <div className="pb-8 text-center">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-600 via-yellow-500 to-red-600 px-4 py-2 rounded-full">
              ...
              <span className="text-white font-semibold text-sm">Proudly Made in Vietnam</span>
              <span className="text-white font-semibold text-sm">🇻🇳</span>
            </div>
          </div>
        </div>
