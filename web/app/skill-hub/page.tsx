...
export default function SkillHubPage() {
  const [journeyStations, setJourneyStations] = useState([
    ...
    // World 2: Realm of Skills
    {
      ...
      icon: Compass,
      status: localStorage.getItem("currentChapter") === "5" ? "current" : "locked",
    ...
    },
    {
      ...
      icon: Trophy,
      status: localStorage.getItem("hasCompletedChapter4") ? "completed" : "current",
  ...
  useEffect(() => {
    setJourneyStations((prevStations) =>
  ...
  const chapter4Completed =
    typeof window !== "undefined" && localStorage.getItem("hasCompletedChapter4");
  ...
  const completedStations = journeyStations.filter(
    (station) => station.status === "completed"
  ).length;
  const totalStations = journeyStations.length;
  const currentStation = journeyStations.find((station) => station.status === "current")?.id || 4;
      ...
      <div className='max-w-7xl mx-auto px-4 py-8 lg:px-8'>
            ...
            <div className='space-y-4'>
              <div className='flex items-center justify-between'>
                ...
                <span className='text-sm text-muted-foreground'>
                  {completedStations}/{totalStations} kỹ năng cốt lõi
                </span>
              </div>
              <Progress value={progressPercentage} className='h-3 bg-muted' />
              <p className='text-sm text-muted-foreground'>
                Bạn đã hoàn thành <strong>{completedStations}</strong> trong tổng số{" "}
                <strong>{totalStations}</strong> chặng hành trình
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className='grid lg:grid-cols-3 gap-8'>
          ...
          <div className='space-y-6'>
            ...
            <Card className='bg-card text-card-foreground border-border'>
              ...
              <CardContent className='space-y-3'>
                <div className='flex justify-between items-center'>
                  ...
                  <Badge variant='outline'>{completedStations}</Badge>
                </div>
                <div className='flex justify-between items-center'>
            ...
            <Card className='bg-card text-card-foreground border-border'>
              <CardHeader>
                <CardTitle className='text-lg'>💡 Truy cập giáo trình</CardTitle>
              </CardHeader>
              <CardContent>
                <p className='text-sm text-muted-foreground mb-4'>
